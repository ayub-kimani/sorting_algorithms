...
The aim of this project is to learn about sorting algorithms (bubble sort, insertion sort, selection sort, quick sort and so on) and Big O Notation in **C language**.
...
| `107-O` | Text file containing the best, average, and worst case time complexities of the **Quick Sort** algorithm 1 notation per line |
| `1000-sort_deck.c` |  function that sorts a `deck_node_t` doubly-linked list deck of cards |
| `deck.h` | Header file, containing the previous data structures definitions |
| `sort.h` | Header file, containing all the prototypes of all the project functions |
